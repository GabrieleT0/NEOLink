...
function EditItem() {
        ...
        const loadItemData = async () => {
            ...
            try {
                ...
                setFormData({
                    ...
                    languages: parseLanguages(itemData.languages),
                    ...
                    notify_on_interest: itemData.notify_on_interest !== undefined ? itemData.notify_on_interest : true,
                    notify_on_interest_email: itemData.notify_on_interest_email !== undefined ? itemData.notify_on_interest_email : false,
                });
    ...
    const handleSubmit = async (e) => {
        ...
        if (shouldShowField('languages', categoryName) && formData.languages.length === 0) {
        ...
        try {
            ...
            const updateData = {
                data: {
                    ...
                    languages: serializeLanguages(formData.languages) || null,
            ...
            updateData.data.notify_on_interest = formData.notify_on_interest;
            updateData.data.notify_on_interest_email = formData.notify_on_interest_email;
                                ...
                                {shouldShowField('languages', categoryName) && (
                                    <div style={{ marginBottom: '1.5rem', position: 'relative' }} ref={languageDropdownRef}>
                                        ...
                                        <div style={{ position: 'relative' }}>
                                            ...
                                            >
                                                <span style={{ color: formData.languages.length > 0 ? '#495057' : '#6c757d', flex: 1 }}>
